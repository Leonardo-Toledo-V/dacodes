...
export default function MovieCard() {
    return (
            <div className="w-60 h-fit group ml-16">
                <div className="relative overflow-hidden rounded-3xl">
                    ...
                    src="/prueba.jpeg" 
                    alt=""/>
                        <div className="absolute h-full w-full bg-[#5241eaa7] flex flex-col items-center pt-10 px-6 -top-0 group-hover:top-0 opacity-0 group-hover:opacity-100 transition-all duration-500 ease-in-out text-white">
