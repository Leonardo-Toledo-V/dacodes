...
export default function UpcomingPage() {
  ...
  useEffect(() => {
    axios("/movie/upcoming", options).then(function (response) {
    ...
    return (
      <>
        ...
        <main className="mx-4 lg:mx-16">
          <Dock />
          <h2 className="text-white text-2xl font-poppinsBold text-center md:text-start md:mx-16 mb-8">Upcoming</h2>
